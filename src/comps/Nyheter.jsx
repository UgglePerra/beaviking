...
export default function Nyheter() {
  ...
  const svt3 = "Domare: HIERNER JULIA";

  const ent3 = "Judge: Julia Hierner";
  ...
  const svt7 = "Nordic Dog Show Västerås 26 april 2026";

  const ent7 = "Nordic Dog Show Västerås, April 26, 2026";

  const svt8 = "Domare Attila Czeglédi , Ungern";

  const ent8 = "Judge: Attila Czeglédi, Hungary";
  ...
  const svt11 = "SE UCH FI UCH Tilevis Flitwick Be A Viking💖💖";

  const ent11 = "SE CH FI CH Tilevis Flitwick Be A Viking💖💖";

  const svt12 = "Agria Dog Show Jönköping Internationell";

  const ent12 = "Agria Dog Show Jönköping International";

  const svt13 = "Domare Nina Lönner Andersson";

  const ent13 = "Judge: Nina Lönner Andersson";

  const svt14 = "Idag fyller han 13 år!! 💖";

  const ent14 = "Today he turns 13!! 💖";

  const svt15 = "Stort grattis älskade Louis❤️❤️❤️";

  const ent15 = "Happy birthday, beloved Louis❤️❤️❤️";

  const svt16 = "Roskilde Internationell utställning";

  const ent16 = "Roskilde International Show";

  const svt17 = "21 september 2025 KÖPENHAMNSVINNARE 2025 🏆";

  const ent17 = "September 21, 2025 COPENHAGEN WINNER 2025 🏆";
  ...
  const svt19 = "Domare Hans Almgren";

  const ent19 = "Judge: Hans Almgren";

  const svt20 = "Grattis till Jenny och Jax!!";
  ...
  return (
    <div className="gallery-page">
      ...
      <div className="text-over-img">
        <h3>{language === "sv" ? "28 juni 2026" : "June 28, 2026"}</h3>
      ...
      <div className="text-over-img">
        <h3>{language === "sv" ? "26 april 2026" : "April 26, 2026"}</h3>
      ...
      <div className="text-over-img">
        <h3>{language === "sv" ? "1 april 2026" : "April 1, 2026"}</h3>
      ...
      <div className="text-over-img">
        <h3>{language === "sv" ? "28 februari 2026" : "February 28, 2026"}</h3>
      ...
      <div className="text-over-img">
        <h3>{language === "sv" ? "1 januari 2026" : "January 1, 2026"}</h3>
