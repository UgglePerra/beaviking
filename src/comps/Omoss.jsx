    ...
    <>
      <div className="gallery-page">
        ...
        <div className="text-spacer">
          ...
          <br /> <br />
          Under åren har lusten att lära mer om våra vänner hundarna bara ökat. Utbildningar som jag Anna-Karin har gått är bl a Svenska Kennelklubbens Uppfödarutbildning, Avel- o Reproduktionsutbildning, Anatomi- och Bedömningsutbildning, Avel och Genetik VKK, ringsekreterare samt har arbetat på Blå stjärnans Djursjukhus. Professionellt är vi båda utbildade civilekonomer. Kontinuerligt går vi på olika kurser och aktivitetsträning som Nosework, Rallylydnad, Valpkurser och vardagslydnad. Ida har tränat och tävlat i juniorhandling med bästa resultat som BIS-1 på Malmös Internationella utställning 2009. Vi är medlemmar i Västsvenska Kennelklubben/Svenska Kennelklubben SKK samt rasklubben BBHC (Bolognese Bichon Havanais Club). Jag Anna-Karin har under åren haft olika roller i rasklubben som styrelseledamot, revisor samt aktivitetsombud Västra kretsen. Idag är jag styrelseledamot med ansvar för ”Avel & Hälsa”.
          <br /> <br />
