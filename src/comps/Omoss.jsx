  ...
  return (
    <>
      <div className="gallery-page">
        ...
        <br /> <br />
        En sommar träffade vi för första gången havanaiser och blev alldeles förälskade. 2002 hämtade vi hem vår första Havanais Pluto från Aco Tara’s kennel i Stockholm. Pluto följde med oss på allt ifrån skidåkning, fjällvandring, båtturer i skärgården, agility och trivdes med allt, bara han fick vara med. När Napoleon kom in i familjen och klev rakt in i våra hjärtan började intresset för hundutställningar ta fart på allvar. En fantastisk resa började och drivkraften växte att lära mer om hundens beteende, positiv inlärning, avelsarbete och anatomi. Då Napoleon blev pappa för första gången hävdade Ida bestämt att man absolut måste behålla en valp – så Sirius flyttade in! Så efter alla kurser, utbildningar och utställningar – ivrigt påhejade av vänner att vi måste skaffa en tik då engagemanget var så stort - så hämtade vi hem vår Malva från Tyskland 2010. En alldeles underbart vacker och rolig liten tik som spred glädje och kärlek varje dag! Hon blev mamma till våra två första valpkullar där Sessan och Bell stannade kvar. Två underbara Havanais tikar; som förutom att glädja oss varje dag nådde mycket fina framgångar i utställningsringarna! 
        <br /> <br />
