...
export default function Minnie() {
  ...
  const ent2 = "Minnie is our little miracle, a gift from above — well, she actually comes from Luleå, from Anna and Linnea at Kennel Evan’s Aha, where her mother, Soda, lives. Her father is Texas from Candygolds. Minnie’s maternal grandmother, Vickan (Be A Viking Berylla Boffin), was born here with us, and her great-grandmother, Malva (Peach Blossom Blue Temptation), was the first female we brought home from Germany. Minnie has four of our own dogs in her pedigree.";
  ...
  const ent3 = "But above all, she is a fun and beautiful young lady—confident and curious. She is so affectionate, showering everyone with nose kisses. Minnie has appointed herself the boss of the house! She has also done well in the show ring: Copenhagen Winner 2025, Copenhagen Junior Winner 2025, Best of Breed in Askersund, multiple Best Bitch placements, and championship certificates in both Sweden and Denmark.";

  const svt4 =
    "På första försöket blev hon svensk och dansk champion på den nordiska utställningen i Västerås 26 april 2026!";

  const ent4 = "At her first attempt, she became both a Swedish and Danish Champion at the Nordic dog show in Västerås on April 26, 2026!";

  const svt5 = "Minnie är hälsotestad; ögon, hjärta, patella utan anmärkning.";

  const ent5 = "Minnie has undergone health testing; her eyes, heart, and patellas are all clear.";
