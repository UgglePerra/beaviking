    ...
    <div className="gallery-page">
      <div className="text">
        ...
        <div>
          ...
          Hans vilja att samarbeta och starka mentalitet gjorde att han nådde mycket stora framgångar i utställningsringarna med ett flertal Best In Show, Best In Group, Bäst i Rasen, Mestvinnande Havanais tre år i rad, Best In Show på Rasspecialen och Vinnar-titlar!<br /><br />
