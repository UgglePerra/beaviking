...
export default function Pluto () {
  return (
    <div className="gallery-page">
      <div className="text">
        <h1>Pluto <br />(Aco Tara&apos;s Daylightuto)</h1>
        <div>
          <h3>Födelsefakta</h3>
